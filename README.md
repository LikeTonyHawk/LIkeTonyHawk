...
support my continued growth in cloud security, identity, endpoint protection, 
...
### ☁️ [Azure Hybrid Identity & Security Monitoring Lab](https://github.com/LikeTonyHawk/Azure-Security-Monitoring-Lab)
